...
/* USER CODE BEGIN PV */
uint32_t blueLedLastToggleMs = 0;
...
//  MX_SPI1_Init();
  ...
  while (1)
  {
	  // HAL_GPIO_WritePin(LED_GREEN_PORT, LED_GREEN, canOpenNodeSTM32.outStatusLEDGreen);
	  // HAL_GPIO_WritePin(LED_RED_PORT, LED_RED, canOpenNodeSTM32.outStatusLEDRed);
    
	  // if ((HAL_GetTick() - blueLedLastToggleMs) >= 1000U) {
