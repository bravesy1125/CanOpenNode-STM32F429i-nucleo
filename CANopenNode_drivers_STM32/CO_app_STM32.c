...
canopen_app_process() {
    ...
    if ((time_current - time_old) > 0) { // Make sure more than 1ms elapsed
        ...
        HAL_GPIO_WritePin(LED_GREEN_PORT, LED_GREEN, canopenNodeSTM32->outStatusLEDGreen = CO_LED_GREEN(CO->LEDs, CO_LED_CANopen));
	    HAL_GPIO_WritePin(LED_RED_PORT, LED_RED, canopenNodeSTM32->outStatusLEDRed = CO_LED_RED(CO->LEDs, CO_LED_CANopen));
