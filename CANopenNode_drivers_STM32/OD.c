...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1008_manufacturerDeviceName = {'y', 'o', 'n', 'g', 's', 'h', 'i', 't', 'e', 's', 't', 0},
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2000_testvar1_uint32 = 0x11223344,
    .x2001_testvar2_uint16 = 0x5566
};
...
typedef struct {
    ...
    OD_obj_var_t o_2000_testvar1_uint32;
    OD_obj_var_t o_2001_testvar2_uint16;
    OD_obj_var_t o_2004_testdomain;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2000_testvar1_uint32 = {
        .dataOrig = &OD_RAM.x2000_testvar1_uint32,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 4
    },
    .o_2001_testvar2_uint16 = {
        .dataOrig = &OD_RAM.x2001_testvar2_uint16,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2004_testdomain = {
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2000, 0x01, ODT_VAR, &ODObjs.o_2000_testvar1_uint32, NULL},
    {0x2001, 0x01, ODT_VAR, &ODObjs.o_2001_testvar2_uint16, NULL},
    {0x2004, 0x01, ODT_VAR, &ODObjs.o_2004_testdomain, NULL},
