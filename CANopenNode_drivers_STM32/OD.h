...
********************************************************************************
    ...
    File info:
        ...
        Created:      11/23/2020 12:00:00 PM
        Created By:   
        Modified:     3/10/2026 3:06:07 PM
        Modified By:  

    Device Info:
        Vendor Name:  MyCompany
        Vendor ID:    1
        Product Name: STM32F429I CANopen Device
        Product ID:   1
...
typedef struct {
    ...
    uint32_t x2000_testvar1_uint32;
    uint16_t x2001_testvar2_uint16;
} OD_RAM_t;
...
#define OD_ENTRY_H2004 &OD->list[22]
...
#define OD_ENTRY_H2000_testvar1_uint32 &OD->list[20]
#define OD_ENTRY_H2001_testvar2_uint16 &OD->list[21]
#define OD_ENTRY_H2004_testdomain &OD->list[22]
